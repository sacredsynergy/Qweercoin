...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Qweercoin
else
  DOCKER_EXEC echo \> \$HOME/.qweercoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/qweercoin/qweercoin/pull/18288#discussion_r433189350 for
  # details.
