# Bootstrappable Qweercoin Core Builds

This directory contains the files necessary to perform bootstrappable Qweercoin
Core builds.
...
- 24GB of free disk space on the partition that the Qweercoin Core git repository
  resides in
...
For a Qweercoin Core depends development environment, simply invoke
...
From the top of a clean Qweercoin Core repository:
...
To use dongcarl's substitute server for Qweercoin Core builds after having
