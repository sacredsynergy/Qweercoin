...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the qweercoin repository."
  exit 1
fi
...
# See https://github.com/qweercoin/qweercoin/issues/16064
...
echo 'When compiling qweercoind, run `./configure` in the following way:'
echo
