#!/usr/bin/env python3
# Copyright (c) 2014-2021 The Qweercoin Core developers
...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef QWEERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define QWEERCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the qweercoin network\n')
    ...
    g.write('#endif // QWEERCOIN_CHAINPARAMSSEEDS_H\n')
