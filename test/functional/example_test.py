...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the QweercoinTestFramework
    pass


class ExampleTest(QweercoinTestFramework):
    # Each functional test is a subclass of the QweercoinTestFramework class.
    ...
    def custom_method(self):
        ...
        QweercoinTestFramework class so other tests can use it."""
