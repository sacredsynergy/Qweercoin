#!/usr/bin/env python3
# Copyright (c) 2021 The Qweercoin Core developers
...
from test_framework.qwr_util import create_non_hd_wallet, setup_mweb_chain
from test_framework.util import assert_equal

class MWEBWalletUpgradeTest(QweercoinTestFramework):
    ...
    def run_test(self):
        ...
        #
        # Create a non-HD wallet using an older qweercoin core version
        #
