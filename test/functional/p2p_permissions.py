...
class P2PPermissionsTests(QweercoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].qweercoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].qweercoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
