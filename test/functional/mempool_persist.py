...
By default, qweercoind will dump mempool on shutdown and
...
class MempoolPersistTest(QweercoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent qweercoind from writing mempool.dat to disk. Verify that `savemempool` fails")
