...
class TestShell:
    """Wrapper Class for QweercoinTestFramework.

    The TestShell class extends the QweercoinTestFramework
    ...
    class __TestShell(QweercoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by QweercoinTestFramework child class.
            self.num_nodes = 1
