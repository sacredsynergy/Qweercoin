...
This file is modified from python-qweercoinlib.
"""
...
def bn2vch(v):
    """Convert number to qweercoin-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in Twinks codebase"""
    r = b''
