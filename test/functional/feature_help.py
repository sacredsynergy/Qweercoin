...
"""Verify that starting qweercoin with -h works as expected."""

from test_framework.test_framework import QweercoinTestFramework
from test_framework.util import assert_equal

class HelpTest(QweercoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start qweercoin with -h for help text")
        ...
        self.log.info("Start qweercoin with -version for version information")
        ...
        self.log.info("Start qweercoind with -fakearg to make sure it does not start")
