Download URL: https://sourceforge.net/projects/qweercoin/files/Qweercoin/qweercoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 QWR fee schedule (users still pay 0.01 QWR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #qweercoin00 - #qweercoin99
