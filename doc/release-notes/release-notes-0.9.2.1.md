Qweercoin Core version 0.9.2.1 is now available from:

  https://qweercoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 QWR to 0.01 QWR
...
- Fix "Start qweercoin on system login"
