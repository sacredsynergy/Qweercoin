...
Qweercoin Core version 0.19.1 is now available from:

  <https://qweercoincore.org/bin/qweercoin-core-0.19.1/>
...
From Qweercoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Qweercoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Qweercoin Core does not yet change appearance when
...
- #17488 fix "qweercoind already running" warnings on macOS (fanquake)
