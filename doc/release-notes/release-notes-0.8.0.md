Qweercoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/qweercoin/files/Qweercoin/qweercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Qweercoin
...
New/changed settings (command-line or qweercoin.conf file)
--------------------------------------------------------
