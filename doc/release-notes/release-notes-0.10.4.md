Qweercoin Core version 0.10.4 is now available from:

  <https://qweercoin.org/bin/qweercoin-core-0.10.4/>
...
- #6953 `43c2789` Split qweercoin-tx into its own package
- #6953 `dfe0d4d` Include qweercoin-tx binary on Debian/Ubuntu
