Qweercoin Core version 0.13.2 is now available from:
  ...
  <https://qweercoin.org/bin/qweercoin-core-0.13.2/>
...
- #8908 `4a974b2` Update qweercoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow qweercoin-tx to create v2 transactions (btcdrak)
