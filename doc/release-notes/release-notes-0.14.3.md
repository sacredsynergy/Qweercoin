Qweercoin Core version *0.14.3* is now available from:

  <https://qweercoin.org/bin/qweercoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/qweercoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
