Qweercoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/qweercoin/files/Qweercoin/qweercoin-0.5.4/
...
http://gitorious.org/qweercoin/qweercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Qweercoin-Qt notifications under Growl 1.3.
Increase required age of Qweercoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxQweercoin properly when installing Qweercoin-Qt over it. (Windows)
