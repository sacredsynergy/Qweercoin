Qweercoin Core version 0.9.4 is now available from:

  https://qweercoin.org/bin/0.9.4/
...
this update is incompatible with the Qweercoin system and could lead to consensus
forks.

Qweercoin Core released binaries from https://qweercoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~qweercoin/+archive/ubuntu/qweercoin
- A third-party or self-compiled Qweercoin Core

upgrade to Qweercoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
