...
This document provides guidelines for internationalization of the Qweercoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `qweercoin_en.ts` remains unchanged.
