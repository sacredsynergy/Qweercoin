Qweercoin Core version 0.16.2 is now available from:

  <https://download.qweercoin.org/qweercoin-0.16.2/>
...
- #12843 `df38b13` Test starting qweercoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure qweercoind processes are cleaned up when tests end (sdaftuar)
...
- #13797 `6518bcd` qweercoinconsensus: invalid flags should be set to qweercoinconsensus_error type, add test cases covering qweercoinconsensus error codes (Thomas Kerin)
