...
// qweercoin includes.
#include <..\src\script\qweercoinconsensus.h>
...
int main()
{
    std::cout << "qweercoinconsensus version: " << qweercoinconsensus_version() << std::endl;
    ...
    auto op0Result = qweercoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, qweercoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
