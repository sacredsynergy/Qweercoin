...
#ifndef QWEERCOIN_TEST_SCRIPTNUM10_H
#define QWEERCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Qweercoin Core 0.10.0, for cross-comparison.
 */
public:
