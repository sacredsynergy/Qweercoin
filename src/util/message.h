...
#ifndef QWEERCOIN_UTIL_MESSAGE_H
#define QWEERCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's qweercoin address, it must refer to a public key.
...
#endif // QWEERCOIN_UTIL_MESSAGE_H
