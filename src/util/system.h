 ...
 */
#ifndef QWEERCOIN_UTIL_SYSTEM_H
#define QWEERCOIN_UTIL_SYSTEM_H
...
extern const char * const QWEERCOIN_CONF_FILENAME;
extern const char * const QWEERCOIN_SETTINGS_FILENAME;
