...
#ifndef QWEERCOIN_COMPAT_ASSUMPTIONS_H
#define QWEERCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Qweercoin cannot be compiled without assertions."
#endif
...
#endif // QWEERCOIN_COMPAT_ASSUMPTIONS_H
