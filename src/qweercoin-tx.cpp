...
static void SetupQweercoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " qweercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  qweercoin-tx [options] <hex-tx> [commands]  Update hex-encoded qweercoin transaction\n" +
            "or:     qweercoin-tx [options] -create [commands]   Create hex-encoded qweercoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded qweercoin transaction
