...
#ifndef QWEERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define QWEERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@qweercoin.
 *
 ...
 *
 * The chacha20-poly1305@qweercoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@qweercoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@qweercoin are relatively fast in
...
#endif // QWEERCOIN_CRYPTO_CHACHA_POLY_AEAD_H
