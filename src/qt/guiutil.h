...
#ifndef QWEERCOIN_QT_GUIUTIL_H
#define QWEERCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Qweercoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "qweercoin:" URI into recipient object, return true on successful parsing
