...
#ifndef QWEERCOIN_QT_OPTIONSMODEL_H
#define QWEERCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Qweercoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // QweercoinUnits::Unit
...
#endif // QWEERCOIN_QT_OPTIONSMODEL_H
