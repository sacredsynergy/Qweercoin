...
#ifndef QWEERCOIN_QT_TRANSACTIONTABLEMODEL_H
#define QWEERCOIN_QT_TRANSACTIONTABLEMODEL_H
...
private:
    ...
    QString formatTxAmount(const WalletTxRecord *wtx, bool showUnconfirmed=true, QweercoinUnits::SeparatorStyle separators=QweercoinUnits::SeparatorStyle::STANDARD) const;
...
#endif // QWEERCOIN_QT_TRANSACTIONTABLEMODEL_H
