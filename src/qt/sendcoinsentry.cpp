    ...
    platformStyle(_platformStyle)
{
    ...
    // normal qweercoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying qweercoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &QweercoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
