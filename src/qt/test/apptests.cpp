...
//! Entry point for QweercoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &QweercoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for QweercoinGUI tests.
void AppTests::guiTests(QweercoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &QweercoinGUI::consoleShown, this, &AppTests::consoleTests);
