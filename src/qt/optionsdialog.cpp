    ...
    mapper(nullptr)
{
    ...
    ui->qweercoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->qweercoinAtStartup);
    ...
    ui->qweercoinAtStartup->setToolTip(ui->qweercoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->qweercoinAtStartup->setText(ui->qweercoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openQweercoinConfButton->setToolTip(ui->openQweercoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new QweercoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->qweercoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openQweercoinConfButton_clicked()
{
