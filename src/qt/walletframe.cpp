...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, QweercoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &QweercoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &QweercoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &QweercoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &QweercoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &QweercoinGUI::updateWalletStatus);
    connect(gui, &QweercoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
