...
#ifndef QWEERCOIN_SCRIPT_STANDARD_H
#define QWEERCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a qweercoin address
 */
...
/**
 * Generate a Qweercoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // QWEERCOIN_SCRIPT_STANDARD_H
