...
#ifndef QWEERCOIN_SCRIPT_SCRIPT_H
#define QWEERCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Qweercoin always counted CHECKMULTISIGs
...
#endif // QWEERCOIN_SCRIPT_SCRIPT_H
