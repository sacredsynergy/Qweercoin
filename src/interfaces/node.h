...
#ifndef QWEERCOIN_INTERFACES_NODE_H
#define QWEERCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a qweercoin node (qweercoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // QWEERCOIN_INTERFACES_NODE_H
