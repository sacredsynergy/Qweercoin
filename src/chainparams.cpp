...
{
    const char* pszTimestamp = "Qweercoin 28/Feb/2026 - Love is all.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1740700800, 247252, 0x1e0ffff0, 1, 69 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb760e3a5cb886313c0fef45632e40101d457a07907e9238444729c093fa5ae17"));
        assert(genesis.hashMerkleRoot == uint256S("0x23c8197933d9eb3b2f0ef2251086aea0f542e66e2e831e63383e95e1c673b79d"));
        ...
        vSeeds.emplace_back("seed.qweercoin.com");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1296688602, 0, 0x207fffff, 1, 69 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5c544875b8c1b7b66b0906ebdf3d7da692564c98836b66dc26cc0c8e962ddef6"));
        assert(genesis.hashMerkleRoot == uint256S("0x23c8197933d9eb3b2f0ef2251086aea0f542e66e2e831e63383e95e1c673b79d"));
