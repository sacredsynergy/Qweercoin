// Copyright (c) 2017-2018 The Qweercoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef QWEERCOIN_WALLET_COINSELECTION_H
#define QWEERCOIN_WALLET_COINSELECTION_H
...
#endif // QWEERCOIN_WALLET_COINSELECTION_H
