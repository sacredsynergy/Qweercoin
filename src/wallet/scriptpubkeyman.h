...
#ifndef QWEERCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define QWEERCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Qweercoin Core wallet was originally a collection of unrelated private
...
#endif // QWEERCOIN_WALLET_SCRIPTPUBKEYMAN_H
