...
#ifndef QWEERCOIN_WALLET_WALLETUTIL_H
#define QWEERCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! qweercoin from opening the wallet, thinking it was newly created, and
...
#endif // QWEERCOIN_WALLET_WALLETUTIL_H
