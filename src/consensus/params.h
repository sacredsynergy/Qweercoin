...
#ifndef QWEERCOIN_CONSENSUS_PARAMS_H
#define QWEERCOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Qweercoin Script solution
...
#endif // QWEERCOIN_CONSENSUS_PARAMS_H
