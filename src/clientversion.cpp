 ...
 * for both qweercoind and qweercoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("QweercoinCore");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/qweercoin/bips/blob/master/bip-0014.mediawiki)
 */
