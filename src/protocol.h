...
#ifndef QWEERCOIN_PROTOCOL_H
#define QWEERCOIN_PROTOCOL_H
...
/**
 * Qweercoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Qweercoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // Qweercoin Core does not support this but a patch set called Qweercoin XT does.
    // See BIP 64 for details on how this is implemented.
    NODE_GETUTXO = (1 << 1),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Qweercoin Core nodes used to support this by default, without advertising this bit,
    ...
    // qweercoin-development mailing list. Remember that service bits are just
