...
#ifndef QWEERCOIN_RPC_PROTOCOL_H
#define QWEERCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in qweercoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Qweercoin is not connected
...
#endif // QWEERCOIN_RPC_PROTOCOL_H
