// Copyright (c) 2015-2018 The Qweercoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef QWEERCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
#define QWEERCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // QWEERCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
